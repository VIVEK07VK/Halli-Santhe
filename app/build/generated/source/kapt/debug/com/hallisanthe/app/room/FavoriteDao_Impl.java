  ...
  public FavoriteDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfFavoriteEntity = new EntityInsertionAdapter<FavoriteEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `favorites` (`productId`,`name`,`description`,`price`,`stock`,`category`,`sellerName`,`sellerId`,`imageUrl`,`unit`,`rating`,`discountPercent`,`tag`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
      }
    ...
    this.__preparedStmtOfDeleteFavoriteById = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "DELETE FROM favorites WHERE productId = ?";
        return _query;
      }
    };
  }
      ...
      public List<FavoriteEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new FavoriteEntity(_tmpProductId,_tmpName,_tmpDescription,_tmpPrice,_tmpStock,_tmpCategory,_tmpSellerName,_tmpSellerId,_tmpImageUrl,_tmpUnit,_tmpRating,_tmpDiscountPercent,_tmpTag);
            _result.add(_item);
          }
          return _result;
        } finally {
